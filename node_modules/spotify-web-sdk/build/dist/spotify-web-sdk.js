...
Object.defineProperty(exports, "__esModule", { value: true });
var album_1 = __webpack_require__(19);
...
var artist_1 = __webpack_require__(20);
...
var recommendation_seed_1 = __webpack_require__(21);
...
var playlist_simplified_1 = __webpack_require__(23);
exports.PlaylistSimplified = playlist_simplified_1.default;
var playlist_track_1 = __webpack_require__(22);
...
Object.defineProperty(exports, "__esModule", { value: true });
var recommendation_seed_1 = __importDefault(__webpack_require__(21));
var track_simplified_1 = __importDefault(__webpack_require__(10));
...
Object.defineProperty(exports, "__esModule", { value: true });
var album_1 = __importDefault(__webpack_require__(19));
...
var PlayHistory = (function () {
    ...
    PlayHistory.prototype.getContextData = function () {
        if (this.context) {
            var _a = this.context.uri.split(':'), type = _a[1], id = _a[2];
            switch (type) {
                case 'album':
                    return __1.getAlbum(id);
                case 'artist':
                    return __1.getArtist(id);
                case 'playlist':
                    return __1.getPlaylist(id);
                default:
                    return __1.getAlbum(this.track.album.id);
            }
        }
        return __1.getAlbum(this.track.album.id);
    };
...
var image_1 = __importDefault(__webpack_require__(3));
var page_1 = __importDefault(__webpack_require__(7));
var playlist_track_1 = __importDefault(__webpack_require__(22));
var user_public_1 = __importDefault(__webpack_require__(8));
...
var page_1 = __importDefault(__webpack_require__(7));
var album_simplified_1 = __importDefault(__webpack_require__(11));
var artist_1 = __importDefault(__webpack_require__(20));
var playlist_simplified_1 = __importDefault(__webpack_require__(23));
var track_1 = __importDefault(__webpack_require__(4));
